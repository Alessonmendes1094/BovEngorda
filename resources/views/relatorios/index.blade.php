    ...
    <div class="col s15 l5 painel" id="gmdAnimal-baixado" style="display:none">
        <div class="card">
            <div class="card-content">
                ...
                <div class="row">
                    <form action="{{route('relatorios.gmdAnimal-baixados')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="input-field col s12">
                            <i class="material-icons prefix">pets</i>
                        ...
                        <div class="input-field col s12">
                            <i class="material-icons prefix">person</i>
                            <select id="fornecedor_2" class="forn" name="fornecedores[]" required>
                                <option value="" selected disabled>Escolha os Fornecedores</option>
                                @foreach($fornecedores as $forncedor)
                                <option value="{{$forncedor->id}}">{{$forncedor->nome}}</option>
                                @endforeach
                        ...
                        <div class="input-field col s12">
                            <i class="material-icons prefix">pets</i>
                            <select id="compra_fornecedores_2" class="compra_fornecedor" name="compra_fornecedor[]" required>
                                <option value="" disabled>Escolha o Lote de Compra</option>
                            </select>
                            <label for="compra_fornecedores_2">Lotes de Compra</label>
                        </div>
                        <div class="col s12 right">
                            <button type="submit" class="btn green right">Gerar Relatório</button>
                        </div>
            ...
            <div class="card-content">
                ...
                <div class="row">
                    <form action="{{route('relatorios.custo_Animal')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-field col s12">
                            <i class="material-icons prefix">pets</i>
                            <select id="fornecedores_3" class="forn" name="fornecedores[]" required>
                                <option value="" selected disabled>Escolha os Fornecedores de Compra</option>
                        ...
                        <div class="input-field col s12">
                            <i class="material-icons prefix">pets</i>
                            <select id="compra_fornecedores_3" class="compra_fornecedor" name="compra_fornecedor[]" required>
                                <option value="" disabled>Escolha o Lote de Compra</option>
                            </select>
    ...
    <div class="col s15 l5 painel" id="compras_animais" style="display:none">
        <div class="card">
            <div class="card-content">
                ...
                <div class="row">
                    <form action="{{route('relatorios.compras_Animal')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="input-field col s12">
                            <i class="material-icons prefix">pets</i>
                            <select id="fornecedores_4" class="forn" name="fornecedores[]" required>
    ...
    <div class="col s15 l5 painel" id="vendas_animais" style="display:none">
        <div class="card">
            <div class="card-content">
                ...
                <div class="row">
                    <form action="{{route('relatorios.vendas_Animal')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="input-field col s6">
                            <i class="material-icons prefix">date_range</i>
    ...
    <div class="col s9 l9 painel" id="financeiro_pagar" style="display:none">
        <div class="card">
            <div class="card-content">
                ...
                <div class="row">
                    <form action="{{route('relatorios.financeiro_pagar')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col s6">
                            <div class="input-field col s6">
                                <i class="material-icons prefix">date_range</i>
    ...
    <div class="col s9 l9 painel" id="financeiro_receber" style="display:none">
        <div class="card">
            <div class="card-content">
                ...
                <div class="row">
                    <form action="{{route('relatorios.financeiro_receber')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col s6">
                            <div class="input-field col s6">
                                <i class="material-icons prefix">date_range</i>
...
<script type="text/javascript">
    $(function() {
        $('.forn').change(function(event) {

            $(".compra_fornecedor option").remove();

            var id = event.currentTarget.value;
            console.log(id);
            $.ajax({
                type: 'GET'
                , url: "{{url('/manejo/compra/fornecedores/autocomplete')}}"
                , data: {
                    fornecedores: id
                }
                , dataType: "json"
                , success: function(dados) {
                    ...
                    var i = 0
                    $.each(dados, function(id, compra) {
                        i = i + 1;

                        var data = compra.data;
                        var dataFormatada = data.replace(/(\d*)-(\d*)-(\d*).*/, '$3/$2/$1');

                        $(".compra_fornecedor").formSelect().append($('<option>', {
                            value: compra.id
                            , text: id + ' -> ' + dataFormatada
                        }));
                    });
