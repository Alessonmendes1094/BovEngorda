            ...
            <div class="card">
                <div class="card-content">
                    <div class="col s12">
                        ...
                        <a href="{{route('relatorios.compras_Animal.excel' , ['animais'=>$stringAnimais ,'racas'=>$stringRacas , 'fornecedores'=>$stringFornecedores ,'dataini'=>$dataini , 'datafim'=>$datafim])}}"
                           class="btn green right">Baixar Excel</a>
                    </div>
                    <span class="card-title">Compas de Animais</span>
                    <table>
                        <thead>
                        <tr>
                            <th>#</th>
