...
@section('content')
    <div class="row">
        ...
        <div class="col s12 l9">
            <div class="card">
                <div class="card-content">
                    <span class="card-title">Manejos de Compra</span>
                    <div class="row">
                            ...
                            <table>
                                ...
                                @foreach($manejos as $manejo)
                                    <tr>
                                        ...
                                        <td>R$ {{number_format($manejo->valorkg, 2, ',', '.')}}</td>
                                        <td>{{number_format($manejo->total_peso,3, ',', '.')}} Kg</td>
                                        <td>
                                            <a class="btn orange" href="{{route('compra.edit', $manejo->id)}}">
