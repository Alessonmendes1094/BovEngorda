                ...
                <div class="card-content">
                    ...
                    <div class="row">
                        <div class="col s12 right">
                            <a class="btn green white-text right" href="{{route('cliente.index')}}"><i
                        ...
                        <div class="col s12">
                            <div class="row ">
                                ...
                                <div class="col s12 m12 l8 center-align">
                                    <form class="form-cliente" method="POST" action="{{route('cliente.save')}}">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                ...
                                                <input id="nome" name="nome" type="text" class="validate"
                                                       value="{!! isset($cliente) ? $cliente->nome : null !!}"
                                                       required>
                                                <label for="nome">Nome</label>
                                            </div>
                                            <div class="col s12">
                                                <button type="submit"
                                                        class="btn green right">{!! isset($cliente) ? 'Editar' : 'Salvar' !!}</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
